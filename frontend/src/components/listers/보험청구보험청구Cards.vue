        ...
        >
            <v-row>
                <v-list-item class="d-flex" style="background-color: white;">
                    <h1 class="align-self-center ml-3">보험청구</h1>
        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                <v-dialog v-model="openDialog" width="500">
                    <보험청구보험청구 :offline="offline"  :isNew="true" :editMode="true" v-model="newValue" 
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            var temp = await axios.get(axios.fixUrl('/보험청구'))
            me.values = temp.data._embedded.보험청구;
